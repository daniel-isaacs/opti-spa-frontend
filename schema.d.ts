...
export type FormContainerBlock = IContent & {
     ...
     * @translatable    true
     */
    resetConfirmationMessage: PropertyLongString
...
/**
 * ODP List Consent Form Block
 * 
 *
 * @ContentBase Block
 * @ContentGuid a4661d51-4160-4eb3-845a-b287b5cfbb26
 */
 ...
 *
 * @ContentBase Block
 * @ContentGuid fed7d217-d2df-4c6e-9cb3-9290bdb2ece5
 */
...
/**
 * Reset Password Page
 * Page for allowing users to reset their passwords. The page must also be set in the StartPage ResetPasswordPage property.
 *
 * @ContentBase Page
...
/**
 * Webhook Factory
 * Add/manage a webhook
 *
 * @ContentBase Block
 * @ContentGuid aeecadf2-3e89-4117-adeb-f8d43565d3f4
 */
export type WebhookFactoryBlock = IContent & {
    /**
     * Target
     * 
     * 
     ...
     * @translatable    false
     */
    webhookType: PropertyLongString
     ...
     * @translatable    false
     */
    serializationConfig: PropertyLongString
}
