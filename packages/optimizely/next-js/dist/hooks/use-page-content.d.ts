...
export declare function usePageContent(ref: ContentReference, inEditMode?: boolean, locale?: string): import("swr").SWRResponse<IContentData | undefined, {}, import("swr").SWRConfiguration<IContentData | undefined, {}, (arg: string) => import("swr/dist/_internal").FetcherResponse<IContentData | undefined>> | undefined>;
